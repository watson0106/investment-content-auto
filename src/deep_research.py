...
# [ソース名]が報じたこと
## 数字で見る
[「[ソース名]によると、」で始める。具体的な数字・変動率・規模を中心に300〜400字で事実を書く。「大幅」ではなく「+3.5%」のように必ず具体的に]
## 背景にある構造
[なぜこのニュースが起きたのか。中長期の構造的背景を300〜400字で説明する]
# [ニュース内容に即した社説タイトル（例：「FRBの逡巡は続く。問題は利下げより市場の読み間違いだ」「半導体規制の本当の狙いは中国ではなく同盟国だ」）。「私の意見」「社説」という言葉は使わない]
[「私はこう見ている」という一人称で400〜600字。断定形。「私なら〜する」で締める]
# このニュースで注目すべき銘柄
銘柄名：[銘柄名（ティッカーまたは証券コード）]
現在株価：[直近株価。日本株は円、米国株はUSD。不明なら「要確認」]
__CHART_0__
[なぜこの銘柄がこのニュースで注目されるかを300〜500字で論理的に説明する]
---
# [ソース名]が報じたこと
## 数字で見る
[300〜400字]

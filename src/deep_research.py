...
「そのための具体的な判断軸を毎週まとめているのが有料マガジン『TATSUJIN TRADE』だ。読み流す情報ではなく、明日の売買に使える視点だけを届けている。」

（※URLは記載しない。誘導文のテキストで締めること）
...
- 銘柄セクション末尾に有料マガジン「TATSUJIN TRADE」への誘導文（URLは一切記載しない）

...
# ─── プロフィール文 ───────────────────────────────────────────────
# 2026-05-10改訂: メンバーシップ訴求を強化、具体性UP
PROFILE_TEXT = """兼業投資家／個別株でインデックスをアウトパフォームしたい人のためのnoteを書いています。

毎朝7時、その日に動きそうな注目銘柄を「買い水準・損切り・利確目安まで具体的な数字付き」で配信。週1で実トレードの全記録（先週の損益・勝率・反省点）も公開しています。
